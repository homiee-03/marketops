...
export default function Hero() {
  return (
    <section id="home" className="noise-overlay relative flex min-h-screen items-center overflow-hidden pt-28">
      ...
      <div className="container-premium relative z-10 grid items-center gap-14 lg:grid-cols-[1.05fr_0.95fr]">
        <motion.div variants={staggerContainer} initial="hidden" animate="visible" className="max-w-4xl">
          ...
          <motion.h1 variants={fadeUp} className="text-5xl font-semibold tracking-[-0.07em] text-white sm:text-7xl lg:text-8xl">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.45 }} className="relative hidden lg:block">
          ...
          <motion.div animate={{ y: [0, -16, 0] }} transition={{ duration: 5, repeat: Infinity }} className="glass-card absolute -left-10 top-24 rounded-3xl p-5">
